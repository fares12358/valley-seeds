...
const DASHBOARD_ICONS = [FiUsers, FiPackage, FiGlobe, FiShield, FiMapPin];
...
const ERP = () => {
  ...
  return (
    <section className="relative py-24 lg:py-32 bg-gradient-to-br from-[#012a14] via-[#037338] to-[#05964a] overflow-hidden">
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#96C422]/5 rounded-full blur-3xl translate-x-1/3 -translate-y-1/3" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2.5 text-xs tracking-[0.2em] uppercase text-[#96C422] mb-6">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-normal leading-tight mb-6 text-white">
              {e.heading}<br />
              <span className="text-[#96C422]">{e.heading_accent}</span>
            </h2>
              ...
              {e.points.map((pt, index) => (
                ...
                >
                  <div className="mt-1 flex-shrink-0">
                    <div className="w-6 h-6 rounded-lg bg-[#96C422]/15 flex items-center justify-center group-hover:bg-[#96C422]/25 transition-colors duration-300">
                      <FiCheckCircle className="w-3.5 h-3.5 text-[#96C422]" />
                    </div>
                  </div>
                  <div>
                    <div className="text-sm font-semibold text-white mb-1 group-hover:text-[#96C422] transition-colors duration-300">
                      {pt.title}
                    </div>
          ...
          >
            <div className="bg-white/10 backdrop-blur-xl rounded-3xl border border-white/15 shadow-[0_8px_40px_rgba(0,0,0,0.2)] overflow-hidden">
              <div className="px-6 py-5 border-b border-white/10 flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-[#96C422] animate-pulse" />
                <span className="text-xs tracking-[0.15em] uppercase text-[#96C422] font-medium">
                  {e.dashboard.label}
                </span>
              </div>
              ...
              <div className="p-2">
                {e.dashboard.items.map((item, index) => {
                  const Icon = DASHBOARD_ICONS[index];
                  return (
                    <motion.div
                      key={index}
                    ...
                    >
                      <span className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-xl bg-[#96C422]/10 flex items-center justify-center group-hover:bg-[#96C422]/20 transition-colors duration-200">
                          <Icon className="w-5 h-5 text-[#96C422]" />
                        </div>
              ...
              <div className="px-6 py-4 border-t border-white/10 bg-white/5">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] text-[#96C422] tracking-wider">{e.dashboard.just_now}</span>
                </div>
              </div>
            </div>
