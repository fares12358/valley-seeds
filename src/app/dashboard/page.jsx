...
export default function DashboardOverviewPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Stat cards — real data from useMessages */}
      ...
      {/* Unread message preview — only shown when there are unread messages */}
      {!loading && unreadCount > 0 && (
        <div className="bg-[#037338]/5 border border-[#037338]/15 rounded-2xl p-5">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link
              href="/dashboard/messages"
              className="text-xs font-medium text-[#037338] hover:underline"
            >
              View all →
            </Link>
          </div>
