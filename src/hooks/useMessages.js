...
import { getMessages, markRead as markReadApi, deleteMessage } from "@/services/contact.service";
...
export function useMessages() {
  ...
  return { messages, loading, error, unreadCount, markRead, deleteMsg, refetch: fetchMessages };
}
